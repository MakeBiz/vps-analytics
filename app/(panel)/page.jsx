    ...
    <div className="grid" style={{ gap: 14 }}>
      ...
      <Card title="Как читать каналы" hint="реклама против органики">
        <div className="note" style={{ margin: 0 }}>
          ...
          <b style={{ color: '#5b7a99' }}>Соцсети</b> это переходы из VK, Telegram, YouTube и подобных. «Другие сайты» это
          переходы с чужих сайтов, «Прямые заходы» это без реферера (набрали адрес или из закладки).
          <br /><br />
          Важно про столбцы: <b>Заходы</b> это число визитов, а <b>Переходы</b> и <b>Конверсия</b> во всех строках считают
          переход к <b>провайдеру</b> (клик по ссылке к хостеру).
        </div>
      </Card>
