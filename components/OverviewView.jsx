...
export default function OverviewView({ ovRows, prevRows, dayRows, hourRows, siteRows, channelRows, provRows, provNames, sites, tz }) {
  ...
  // каналы: агрегируем по выбранным сайтам. Заход без реферера уже разложен по
  // движку сайта на стороне запроса (query.js SRC_CHANNEL), отдельного канала
  // «Органика · без источника» больше нет.
  const chMap = {};
