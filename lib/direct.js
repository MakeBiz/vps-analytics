...
export const VPS_CAMPAIGN_ALLOW = new Set([
  '708098448', '706715098', '706716163', '712849076', '713792287', // Timeweb (VIP/МСК/Регионы/бренд)
  '713636116',                                          // Timeweb МСК РСЯ (сеть)
  '713885050',                                          // TW МСК new (коммерция)
  '708902123', '713897708',                            // AdminVPS (МСК + бренд)
  '713771451', '713886032',                            // Aeza (бренд + коммерция)
  '713886156',                                          // Провайдер Регионы (бренд)
  '713775967',                                          // ishosting
  '713245534', '713793556',                            // Podborvps (старый + новый)
  '713332123', '713793989',                            // Servercalc (старый + новый)
]);
// Намеренно НЕ включаем 713238736 «Solara» — это другой продукт, не VPS, иначе
// он исказит расход/CPC/CPA VPS-доски. Если понадобится — добавить сюда.
